...
function kommastellen(x: number): string {
...
var af18zuwelt: number = kommastellen(100 * af18 / welt18);
var sa18zuwelt: number = kommastellen(100 * sa18 / welt18);
var eu18zuwelt: number = kommastellen(100 * eu18 / welt18);
var na18zuwelt: number = kommastellen(100 * na18 / welt18);
var as18zuwelt: number = kommastellen(100 * as18 / welt18);
var au18zuwelt: number = kommastellen(100 * au18 / welt18);
...
// Emissionswerte relativ zur Welt Anfang Ergebnis
...
// Emissionswerte relativ zur Welt End Ergebnis (100-Anfang)
var af0818f: number = kommastellen(af0818a - 100);
var sa0818f: number = kommastellen(sa0818a - 100);
var eu0818f: number = kommastellen(eu0818a - 100);
var na0818f: number = kommastellen(na0818a - 100);
var as0818f: number = kommastellen(as0818a - 100);
var au0818f: number = kommastellen(au0818a - 100);

// Vergleich 2018 zu 2008
var af0818k: number = kommastellen(af18 - af08);
var sa0818k: number = kommastellen(sa18 - sa08);
var eu0818k: number = kommastellen(eu18 - eu08);
var na0818k: number = kommastellen(na18 - na08);
var as0818k: number = kommastellen(as18 - as08);
var au0818k: number = kommastellen(au18 - au08);
...
function europeON(): void {

    var weltElement = document.querySelector(".chart");
